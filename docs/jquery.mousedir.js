(function ($) {
  ...
  MouseDir.prototype = {
    ...
    moveIn: function (e) {
      ...
      this.$element.children("dd").css(this.pos[n]).animate({
        left: 0,
        top: 0
    ...
    moveOut: function (e) {
      ...
      this.$element.children("dd").animate(this.pos[n], this.speed, this.easing);
    }
  }; // PLUGIN DEFINITION
  // ========================
  ...
  function Plugin(option) {
    return this.each(function () {
      ...
      if (!data) $this.data("gl.mousedir", data = new MouseDir(this, options));
  ...
  var old = $.fn.mousedir;
  $.fn.mousedir = Plugin;
  $.fn.mousedir.Constructor = MouseDir; // NO CONFLICT
  // ==================
  ...
  $(document).on("mouseenter.gl", '[data-toggle="mousedir"]', function (e) {
